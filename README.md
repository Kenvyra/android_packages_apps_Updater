...
The `romtype` attribute is the string to be compared with the `ro.kenvyra.releasetype` property.  
The `size` attribute is the size of the update expressed in bytes.  
The `url` attribute is the URL of the file to be downloaded.  
The `version` attribute is the string to be compared with the `ro.kenvyra.build.version` property.  
